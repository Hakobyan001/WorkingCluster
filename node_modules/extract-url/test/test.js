...
describe('Validar funcion principal', () => {
  it('Debe comprobar que retorne No Results si se ingresa un string vacío', () => {
    chai.assert.equal(getMdLinks.matches(''), 'No Results');
  });
});